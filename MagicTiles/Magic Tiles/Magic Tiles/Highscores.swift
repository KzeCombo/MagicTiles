...
class Highscores: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchDisplayDelegate, UISearchBarDelegate {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        if searchText != "" {
            ...
            do{
                arrayHighscore = try context.fetch(fetchReQuest) as! [NSManagedObject]
            }
            catch {
